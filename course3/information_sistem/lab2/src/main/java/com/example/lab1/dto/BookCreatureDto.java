...
public class BookCreatureDto {
    ...
    public BookCreatureDto() {
    }

    public BookCreatureDto(Integer id, String name, Coordinates coordinates, LocalDateTime creationDate, long age, BookCreatureType creatureType, MagicCity creatureLocation, Double attackLevel, long defenseLevel, Ring ring) {
        this.id = id;
        this.name = name;
